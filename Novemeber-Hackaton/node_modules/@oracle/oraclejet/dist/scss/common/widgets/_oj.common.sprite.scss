...
@mixin oj-fwk-icon-document-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
...
@mixin oj-fwk-icon-status-confirmation2-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-204px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
...
@mixin oj-fwk-icon-status-error-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-217px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-status-error2-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-237px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(9px * #{$scaleFactor});
  height: calc(9px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-status-info-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-250px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-status-warning-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-283px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-status-warning2-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-303px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(9px * #{$scaleFactor});
  height: calc(9px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-zoom-in-16-act-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-316px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-zoom-in-16-dis-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-336px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-zoom-in-16-ena-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-356px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-zoom-in-16-hov-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-376px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-zoom-out-16-act-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-396px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-zoom-out-16-dis-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
...
// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-zoom-out-16-ena-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
...
// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-zoom-out-16-hov-scale($scaleFactor: 1) {
  background-size: calc(476px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
...
@if $includeIconClasses != false {
  @include module-include-once("common.sprite") {
    ...
    .oj-fwk-icon-zoom-in-16-act {
      background-image: oj-common-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-zoom-in-16-act-scale;
    }

    /* in high-contrast mode, background-image disappears, so we have to use content */
    .oj-hicontrast .oj-fwk-icon-zoom-in-16-act {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-zoom-in-16-act:before {
      content: oj-common-image-url('zoom_in_16_act.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print {
      ...
      .oj-fwk-icon-zoom-in-16-act:before {
        content: oj-common-image-url('zoom_in_16_act.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-zoom-in-16-dis {
      background-image: oj-common-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-zoom-in-16-dis-scale;
    }

    /* in high-contrast mode, background-image disappears, so we have to use content */
    .oj-hicontrast .oj-fwk-icon-zoom-in-16-dis {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-zoom-in-16-dis:before {
      content: oj-common-image-url('zoom_in_16_dis.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print {
      ...
      .oj-fwk-icon-zoom-in-16-dis:before {
        content: oj-common-image-url('zoom_in_16_dis.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-zoom-in-16-ena {
      background-image: oj-common-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-zoom-in-16-ena-scale;
    }

    /* in high-contrast mode, background-image disappears, so we have to use content */
    .oj-hicontrast .oj-fwk-icon-zoom-in-16-ena {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-zoom-in-16-ena:before {
      content: oj-common-image-url('zoom_in_16_ena.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print {
      ...
      .oj-fwk-icon-zoom-in-16-ena:before {
        content: oj-common-image-url('zoom_in_16_ena.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-zoom-in-16-hov {
      background-image: oj-common-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-zoom-in-16-hov-scale;
    }

    /* in high-contrast mode, background-image disappears, so we have to use content */
    .oj-hicontrast .oj-fwk-icon-zoom-in-16-hov {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-zoom-in-16-hov:before {
      content: oj-common-image-url('zoom_in_16_hov.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print {
      ...
      .oj-fwk-icon-zoom-in-16-hov:before {
        content: oj-common-image-url('zoom_in_16_hov.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-zoom-out-16-act {
      background-image: oj-common-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-zoom-out-16-act-scale;
    }

    /* in high-contrast mode, background-image disappears, so we have to use content */
    .oj-hicontrast .oj-fwk-icon-zoom-out-16-act {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-zoom-out-16-act:before {
      content: oj-common-image-url('zoom_out_16_act.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print {
      ...
      .oj-fwk-icon-zoom-out-16-act:before {
        content: oj-common-image-url('zoom_out_16_act.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-zoom-out-16-dis {
      background-image: oj-common-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-zoom-out-16-dis-scale;
    }

    /* in high-contrast mode, background-image disappears, so we have to use content */
    .oj-hicontrast .oj-fwk-icon-zoom-out-16-dis {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-zoom-out-16-dis:before {
      content: oj-common-image-url('zoom_out_16_dis.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print {
      ...
      .oj-fwk-icon-zoom-out-16-dis:before {
        content: oj-common-image-url('zoom_out_16_dis.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-zoom-out-16-ena {
      background-image: oj-common-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-zoom-out-16-ena-scale;
    }

    /* in high-contrast mode, background-image disappears, so we have to use content */
    .oj-hicontrast .oj-fwk-icon-zoom-out-16-ena {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-zoom-out-16-ena:before {
      content: oj-common-image-url('zoom_out_16_ena.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print {
      ...
      .oj-fwk-icon-zoom-out-16-ena:before {
        content: oj-common-image-url('zoom_out_16_ena.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-zoom-out-16-hov {
      background-image: oj-common-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-zoom-out-16-hov-scale;
    }

    /* in high-contrast mode, background-image disappears, so we have to use content */
    .oj-hicontrast .oj-fwk-icon-zoom-out-16-hov {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-zoom-out-16-hov:before {
      content: oj-common-image-url('zoom_out_16_hov.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print {
      ...
      .oj-fwk-icon-zoom-out-16-hov:before {
        content: oj-common-image-url('zoom_out_16_hov.svg');
        width: 100%;
        height: 100%;
      }
